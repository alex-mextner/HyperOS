...
Every contact has a specific technical/legal ask, evidence package, desired agreement, owner, follow-up date, and fallback. Do not begin with a broad request to “support our OS.” Use the target dossiers in [HW-001](../hardware/HW-001-target-portfolio.md#target-dossier) <!-- xref:AOS-HW-001#target-dossier --> and the outreach template in [the contact template](../templates/CONTACT-OUTREACH-TEMPLATE.md#context) <!-- xref:AOS-TPL-CONTACT#context -->.
