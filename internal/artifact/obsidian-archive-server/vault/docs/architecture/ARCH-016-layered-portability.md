---
id: "AOS-ARCH-016"
title: "Layered Portability and Backend Conformance"
status: "Normative foundation"
version: "1.0.0-foundation"
baseline_date: "2026-07-13"
owners: "Architecture Council"
audience: "Engineering, product, security, legal, programme, partner, and community readers"
summary: "Layered Portability and Backend Conformance: scope, decisions, requirements, evidence, risks, and traceability for the Agent OS programme."
---
# Layered Portability and Backend Conformance
...
This document owns the semantics implied by **Layered Portability and Backend Conformance**. It does not assert that every described subsystem already exists. It defines the target model, constraints, evidence needed to trust an implementation, and the boundary with adjacent documents.
...
| AOS-PLAT-104 | Prove two backend implementations expose identical product semantics | P0 | M6 | Run the relevant document, schema, conformance, build, experiment, or hardware checks; independently review boundary compliance and acceptance criteria. |
...
`AOS-PLAT-104` — Prove two backend implementations expose identical product semantics; `AOS-OPEN-096` — Select two unrelated documented SoC families for native ports
