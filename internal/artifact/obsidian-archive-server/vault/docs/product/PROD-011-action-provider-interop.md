---
id: "AOS-PROD-011"
title: "Action and Provider Interoperability"
status: "Normative foundation"
version: "1.0.0-foundation"
baseline_date: "2026-07-13"
owners: "Product Architecture"
audience: "Engineering, product, security, legal, programme, partner, and community readers"
summary: "Action and Provider Interoperability: scope, decisions, requirements, evidence, risks, and traceability for the Agent OS programme."
---
# Action and Provider Interoperability
...
This document owns the semantics implied by **Action and Provider Interoperability**. It does not assert that every described subsystem already exists. It defines the target model, constraints, evidence needed to trust an implementation, and the boundary with adjacent documents.
...
| --- | --- | --- | --- | --- |
| AOS-PROD-121 | Specify action-provider manifests and adapter contracts | P1 | M2 | Run the relevant document, schema, conformance, build, experiment, or hardware checks; independently review boundary compliance and acceptance criteria. |
...
`AOS-PROD-121` — Specify action-provider manifests and adapter contracts; `AOS-PROD-121` — Specify action-provider manifests and adapter contracts
