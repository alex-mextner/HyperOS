...
Use **GitHub** as the authoritative code/spec/evidence repository and **Linear** as the schedule, ownership, dependency, and program-status view. The canonical portable task dataset remains [`tasks.csv`](PLAN-009-task-data-dictionary.md#canonical-schema) <!-- xref:AOS-PLAN-009#canonical-schema -->; platform-specific imports are derived artifacts.
