---
id: "AOS-PROD-012"
title: "Product Surface Tiers and Dependency Rules"
status: "Normative foundation"
version: "1.0.0-foundation"
baseline_date: "2026-07-13"
owners: "Product Architecture"
audience: "Engineering, product, security, legal, programme, partner, and community readers"
summary: "Product Surface Tiers and Dependency Rules: scope, decisions, requirements, evidence, risks, and traceability for the Agent OS programme."
---
# Product Surface Tiers and Dependency Rules
...
This document owns the semantics implied by **Product Surface Tiers and Dependency Rules**. It does not assert that every described subsystem already exists. It defines the target model, constraints, evidence needed to trust an implementation, and the boundary with adjacent documents.
