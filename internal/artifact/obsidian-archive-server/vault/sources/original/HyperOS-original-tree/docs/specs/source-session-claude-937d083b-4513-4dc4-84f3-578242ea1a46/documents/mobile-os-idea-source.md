# Mobile OS Idea Source

> Archive notice: recovered from the source upload referenced by the Claude session. This is historical source evidence only; current authoritative requirements are the top-level specs in docs/specs.

- Original path: `/Users/ultra/.moshi/uploads/Своя мобильная ОС.txt`
- Packaged copy: `originals/svoya-mobilnaya-os.txt`
