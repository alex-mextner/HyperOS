...
- Confirm the neutral working designation and initiate professional trademark clearance; do not publish under “HyperOS.”
- Create private GitHub organization/repositories and Linear workspace with the structure in [the operating model](PLAN-008-linear-github-operating-model.md#workspace-model) <!-- xref:AOS-PLAN-008#workspace-model -->.
