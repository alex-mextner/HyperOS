...
summary: "Risk Register: scope, decisions, requirements, evidence, risks, and traceability for the Agent OS programme."
---
# Risk Register
...
This document owns the semantics implied by **Risk Register**. It does not assert that every described subsystem already exists. It defines the target model, constraints, evidence needed to trust an implementation, and the boundary with adjacent documents.
