---
id: "AOS-VAL-002"
title: "Evidence Bundle and Experiment Schema"
status: "Normative foundation"
version: "1.0.0-foundation"
baseline_date: "2026-07-13"
owners: "Validation Lead"
audience: "Engineering, product, security, legal, programme, partner, and community readers"
summary: "Evidence Bundle and Experiment Schema: scope, decisions, requirements, evidence, risks, and traceability for the Agent OS programme."
---
# Evidence Bundle and Experiment Schema
...
This document owns the semantics implied by **Evidence Bundle and Experiment Schema**. It does not assert that every described subsystem already exists. It defines the target model, constraints, evidence needed to trust an implementation, and the boundary with adjacent documents.
...
`AOS-DOCS-030` — Define public, internal, restricted, and counsel evidence bundles; `AOS-SEC-110` — Implement source-taint and restricted-evidence policy checks
