...
#### AOS-DOCS-020 — Freeze and checksum the complete HyperOS/Agent OS source corpus
...
**Outcome.** Freeze and checksum the complete HyperOS/Agent OS source corpus.
...
**Deliverables:** Normative report or implementation for Freeze and checksum the complete HyperOS/Agent OS source corpus; machine-readable metadata; updated claim/risk/task records; review notes and follow-up issue links.
**Verification:** Run the relevant document, schema, conformance, build, experiment, or hardware checks; independently review boundary compliance and acceptance criteria.
**Evidence:** Versioned report, raw logs/data or source diff, checksums, reviewer identity/status, and links to the exact specification anchors.
...
**Outcome.** Clear a final or fallback project mark and prevent public use of HyperOS or another conflicting designation.
