...
| --- | --- | --- | --- | --- |
| AOS-DOCS-020 | Freeze and checksum the complete AgentOS/Agent OS source corpus | P0 | M0 | Run the relevant document, schema, conformance, build, experiment, or hardware checks; independently review boundary compliance and acceptance criteria. |
...
`AOS-DOCS-020` — Freeze and checksum the complete AgentOS/Agent OS source corpus; `AOS-DOCS-022` — Publish the source authority and conflict map; `AOS-DOCS-022` — Publish the source authority and conflict map
