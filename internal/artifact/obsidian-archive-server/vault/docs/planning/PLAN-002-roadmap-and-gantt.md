...
The baseline starts **2026-07-13** and uses dependency-driven ranges rather than promised shipment dates. The authoritative issue data is [the canonical task CSV](PLAN-009-task-data-dictionary.md#canonical-schema) <!-- xref:AOS-PLAN-009#canonical-schema -->; this document provides the executive view. Dates must be re-baselined after the first 90-day evidence review.
