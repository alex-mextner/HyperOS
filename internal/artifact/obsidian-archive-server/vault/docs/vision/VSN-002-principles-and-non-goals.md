...
summary: "Principles and Non-Goals: scope, decisions, requirements, evidence, risks, and traceability for the Agent OS programme."
---
...
This document owns the semantics implied by **Principles and Non-Goals**. It does not assert that every described subsystem already exists. It defines the target model, constraints, evidence needed to trust an implementation, and the boundary with adjacent documents.
